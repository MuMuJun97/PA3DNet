...
class KittiDataset(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train', save_path=None):
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4, test=False):
    ...
    dataset.set_split(train_split)
    dataset.create_groundtruth_database(train_filename, split=train_split, save_path=save_path)
