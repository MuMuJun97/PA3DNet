...
class MultiHeadv10(RoIHeadTemplate):
    def __init__(self, input_channels, model_cfg, voxel_size, point_cloud_range, num_class=1, **kwargs):
        ...
        self.up_dimension = MLP(input_dim=input_dim, hidden_dim=64, output_dim=256, num_layers=3)
    ...
    def forward(self, batch_dict):
        ...
        for bs_idx in range(batch_size):
            ...
            cur_points = batch_dict['points'][(batch_dict['points'][:, 0] == bs_idx)][:, 1:1+self.num_feats]
